...
import shankarraibagi.resources.ExtentReporterNG;

public class Listeners extends BaseTest implements ITestListener{
	ExtentTest test;
	ExtentReports extentReports=ExtentReporterNG.getReportObject();
	//this will prevent to sync issue in the report that has generated
	...
	public void onTestStart(ITestResult result) {
		...
		extentTest.set(test);//generates the unique id
	}
